...
addon.Nodes.EK = {
    ...
    { id = "PORTAL_EPL_GHOSTLANDS", container = "ek_overworld.map23", mapID = 23, x = 0.5406, y = 0.0846 }, -- Eastern Plaguelands: the portal to the old Ghostlands (Quel'Lithien Lodge) (hand-added: tools/modern_manual.py)
    ...
    { id = "PORTAL_TIRISFAL_PAST_BC_SILVERMOON", container = "ek_overworld.map18_art19", mapID = 18, x = 0.5947, y = 0.6743 }, -- Past Tirisfal (Balnir Farmstead): the portal to the old Silvermoon, and where its way back lands (hand-added: tools/modern_manual.py)
