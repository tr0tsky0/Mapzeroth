...
1242 nodes written across 14 files.
...
- Cost filled in from the old flat per-method default (see the script's docstring) for: phaseswitch (7), portal (174), ship (1), taxi (4), tram (1), zeppelin (2).
